...
## [Unreleased]
### Added
- Add install buttons to README.md
...
- Upgrade `hdmimatrix` library to `v0.5.0`
- Added power switch for HdBT power

### Removed
- Removed old momentary buttons now that we are using power switch
